...
* [Client / Server](/docs/core-concepts/client-server) — understand the roles and responsibilities of clients and servers
* [HTTP 402](/docs/core-concepts/http-402) — understand how payment requirements are communicated to clients
