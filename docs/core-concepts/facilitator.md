...
* [Client / Server](/core-concepts/client-server.md) — understand the roles and responsibilities of clients and servers
* [HTTP 402](/core-concepts/http-402.md) — understand how payment requirements are communicated to clients
